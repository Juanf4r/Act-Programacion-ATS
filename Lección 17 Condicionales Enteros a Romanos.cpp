/*9. Cambiar un Numero Entero a Numeros Romanos 
...
int main() {
	...
	cout << "Digite un numero para convertir a Romanos: "; cin >> numero;
	...
	millares = numero % 10; numero = numero / 10; //millares = 2, numero = 0
